      ...
      <div className="max-w-6xl mx-auto py-16">
        ...
        <div className="mb-20 relative">
          ...
          <h1 className="text-center text-5xl md:text-6xl font-bold text-white mb-4">
            <span className="text-[#FDD744]">Bolsistas</span>
          </h1>
          <p className="text-center text-[#7DCB80] max-w-3xl mx-auto text-lg">
            ...
            para os projetos de pesquisa desenvolvidos pelo grupo.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {scholars.map((scholar, index) => (
            <div 
              ...
              onClick={() => navigate(`/bolsistas/${scholar.id || scholar.name.toLowerCase().replace(/\s+/g, "-")}`)}
            >
              ...
              <div className="flex items-start gap-6">
                <div className="relative">
                  ...
                  <Avatar className="h-16 w-16 text-2xl bg-[#20423E] ring-2 ring-[#FDD744]/20">
                    <AvatarFallback className="bg-[#7DCB80]/10 text-[#FDD744] font-bold">{scholar.initials}</AvatarFallback>
                  </Avatar>
                </div>
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <h2 className="text-xl md:text-2xl font-bold text-white group-hover:text-[#FDD744] transition-colors">{scholar.name}</h2>
                      <p className="text-[#7DCB80] text-sm mb-4">{scholar.role}</p>
                    </div>
